...
Here are some notes made during class: Victorian Era? Do we want to use the term to depict the period?
Introduce Babbage; elaborate later (in the context of her works).
Perhaps include Clarification of terminology here.
Focus on computing in the nineteenth century and today - differences and similarities.
```
